...
{ Pythia8::Pythia pythia;
  ...
  Selector rapidity_selector = SelectorAbsRapMax(1);
  ...
  //output text file
  ofstream fout("goodpythiaPowhegevents30kt10000");
  const char *dir = getenv("PWD");//"/eos/user/m/mverweij/JetWorkshop2017/samples/";
  TString pythiaPowhegevents30kt10002= Form("%s/PythiaEventsTune%dPtHat%.0f.pu14",dir,tune,ptHat);
